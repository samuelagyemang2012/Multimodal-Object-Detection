...
from yolov1_5.models.backbone import darknet_body, multi_darknet
...
def my_yolo_body(input_shape=(448, 448, 3), pretrained_darknet=None):
    input1 = Input(input_shape)
    input2 = Input(input_shape)

    m_darknet = Model([input1, input2], multi_darknet(input1, input2))
...
def my_yolo_head(model_body1, model_body2, bbox_num=2, class_num=10):
    ...
    #
    # xywhc_output1 = Conv2D(5 * bbox_num, 1,
    #                        padding='same',
    #                        kernel_initializer='he_normal',
